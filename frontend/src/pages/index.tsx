      ...
      <div className="content-overlay">
        ...
        <footer className="px-6 py-8 border-t border-white/5">
          <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-gray-600">
            ...
            <div>
              Built with ❤️ at HackCrux 2026 — LNMIIT, Jaipur | Developed by <a href="https://github.com/piyushinfo/TriageIQ" target="_blank" rel="noreferrer" className="text-teal-400 hover:text-cyan-400 transition-colors font-medium">Piyush Sharma</a>
            </div>
